module.exports = {
  ...
  rpc_endpoint: {
    ...
    ropsten: process.env.RPC_ENDPOINT || 'https://u0abc123xy-u0xyz999ab-rpc.us0-aws.kaleido.io',
    mainnet: process.env.RPC_ENDPOINT || 'https://u0abc123xy-u0xyz999ab-rpc.us0-aws.kaleido.io'
  },
